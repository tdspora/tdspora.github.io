        ...
        <div className={clsx(styles.wrapper)}>
            ...
            <div className={clsx(styles.messages)}>
                ...
                <p className={clsx(styles.description)}>
                    We are currently working on this page and will be back soon.
                    If you have any questions contact us at <a href = "mailto: supportepmc-tdm@epam.com">supportepmc-tdm@epam.com</a>
                </p>
            </div>
        </div>
