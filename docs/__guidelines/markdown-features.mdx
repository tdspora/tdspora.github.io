...
```md
Let's see how to [Create a page](/__guidelines/create-a-document).
```

```md
Let's see how to [Create a page](./__guidelines/create-a-document.md).
```
...
Regular Markdown tables are supported.
